...
public class LayoutVisitor implements Visitor {
  ...
  //Método implementado
    ...
    public Object visitRepeatForRangeWhile(RepeatForRangeWhile ast, Object o) {
       return layoutQuaternary("RepeatForRangeWhileCom.", ast.R, ast.E1, ast.C, ast.E2);
    }
  //Método implementado
    @Override
    public Object visitRepeatForRange(RepeatForRange ast, Object o) {
        return layoutTernary("RepeatForRangeCom.", ast.R, ast.E, ast.C);
    }
  //Método implementado
    @Override
    public Object visitRepeatForRangeUntil(RepeatForRangeUntil ast, Object o) {
        return layoutQuaternary("RepeatForRangeUntilCom.", ast.R, ast.E1, ast.C, ast.E2);
    }
  //Método implementado
    @Override
    public Object visitRepeatIn(RepeatIn ast, Object o) {
        return layoutBinary("RepeatInCom.", ast.I, ast.C);
    }
  //Método implementado
    @Override
 ...
 @Override
  public Object visitProcFuncsDeclaration(ProcFuncsDeclaration ast, Object o) {
    return layoutBinary("ProcFuncsDecl.", ast.D1, ast.D2);
  }
  //Método de Visit implementado
  @Override
