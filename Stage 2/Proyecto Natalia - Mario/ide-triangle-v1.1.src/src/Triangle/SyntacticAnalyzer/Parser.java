...
// to represent its phrase structure.
  ...
  Command parseSingleCommand() throws SyntaxError {
    ...
    // Este cubre el V-name ":=" Expression porque este es también un identifier
    ...
    //Agregando el caso del SKIP (Reemplazo del epsilón)
      case Token.SKIP: {
        acceptIt();
        finish(commandPos);
    ...
    case Token.IF:   
      {
        ...
        Command c2AST = parseElifOrElseOfIf(); // Este método me da el arbol de los elifs o del else
        finish(commandPos);
    ...
    */
    ...
    // Aquí toda la factorización de REPEAT
    case Token.REPEAT: {
        acceptIt();
...
//      break;
  ...
  /**
   * Método para la segunda parte de un if, que puede | o else
   * Dada por la gramática: ("|" Expression "then" Command)* "else" Command "end"
   * @return commandAST
   * @throws SyntaxError 
   */
...
//    switch (currentToken.kind) {
//
//      case Token.PROC: {  //"proc" Identifier "(" Formal-Parameter-Sequence ")" "~" Command "end"
//
//        acceptIt();
//        Identifier iAST = parseIdentifier();
//        accept(Token.LPAREN);
...
//        break;
//      }
//      case Token.FUNC: {  //"func" Identifier "(" Formal-Parameter-Sequence ")" ":" Type-denoter "~" Expression
//        acceptIt();
//        Identifier iAST = parseIdentifier();
//        accept(Token.LPAREN);
//        FormalParameterSequence fAST = parseFormalParameterSequence();
...
//         finish(declarationPos);
//         p1AST = new ProcFuncsDeclaration(p1AST, p2AST, declarationPos ); 
//    }
//    while(currentToken.kind == Token.UPRSLASH);
//
//    return p1AST;
