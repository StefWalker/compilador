...
public class TreeVisitor implements Visitor {
    ...
    public Object visitRepeatForRangeWhile(RepeatForRangeWhile ast, Object o) {
         return(createQuaternary("Repeat For Range While Command", ast.R, ast.E1, ast.C, ast.E2));
    }
    //Método implementado
    @Override
    public Object visitRepeatForRange(RepeatForRange ast, Object o) {
        return(createTernary("Repeat For Range Command", ast.R, ast.E, ast.C));
    }
    //Método implementado
    @Override
    public Object visitRepeatForRangeUntil(RepeatForRangeUntil ast, Object o) {
        return(createQuaternary("Repeat For Range Until Command", ast.R, ast.E1, ast.C, ast.E2));
    }
    //Método implementado
    @Override
    public Object visitRepeatIn(RepeatIn ast, Object o) {
        return(createBinary("Repeat In Command", ast.I, ast.C));
    }
    //Método implementado
    @Override
